<div class="row" style="margin-top: 8px;height: 110px">
			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 clearpadding">
				<a href="<?php echo base_url(); ?>"><img style="max-height: 180px;width: 100%" src="https://lh3.googleusercontent.com/proxy/0QDHPjlDE6Sif2S_8xEfLERM8nY0XrfbdgHArjuUcEAG-gtfV6mHcyDqJBkULmoXRoqRHux9-32J35s_1ivH7-ISmjNyj4JZ1Pp2ilTP3xH62GsjI36Rb5Tq" alt="" class="img-responsive"></a>
			</div>
			<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 clearpadding">
				<a href="#"><img style="max-height: 180px;width: 100%" style="max-height: 110px;width: 100%" src="https://shophoavn.com/assets/upload/gallery/banner-shop-hoa-jpg.jpg" alt="" class="img-responsive"></a>
			</div>
		</div>
		<div class="row">
			  ...
			  <div class="container-fluid re-container-fluid">
			    ...
			    <div class="collapse navbar-collapse re-navbar-collapse" id="bs-example-navbar-collapse-1">
			      <ul class="nav navbar-nav">
			        ...
			        <li class="dropdown">
			          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Loại hoa<span class="caret"></span></a>
